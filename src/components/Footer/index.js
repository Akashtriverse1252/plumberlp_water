...
const index = () => {
  return (
    ...
    >
      <div
        className="footerstn xl:w-4/5 w-full mx-auto py-5"
        data-aos-easing="ease-in"
        data-aos-once="true"
        data-aos-duration="400"
        data-aos="fade-in"
      >
        <div class="flex  footerstn_cnt ">
          <div className="s:w-[55%] w-full justify-center items-center flex ">
            <div className="border-2 border-gray-500 p-[10%]  pt-0 relative rounded-3xl text-white text-center footerCnt_scn">
              ...
              <span>
                ...
                <strong> 10 LAKH HOUSE-HOLDS</strong> can get water supply under
                <strong> “Har Ghar Nal Se Jal”</strong> Mission of Bharat
                Government. Let’s join hands to conserve water.
              </span>
            </div>
          </div>
          <div className="2xl:w-[35%] w-[38%] s:flex hidden">
            <EnquiryForm />
          </div>
        </div>
      </div>
