...
const Index = () => {
  ...
  const settings = {
    ...
    responsive: [
      ...
      {
        breakpoint: 600, // Extra small devices
        settings: {
          slidesToShow: 1,
          slidesToScroll: 1,
        },
  ...
  const getAosDuration = (index) => {
    if (index === 0) {
      return 400; // First slide duration
    } else if (index === 1) {
      return 400; // Second slide duration
    } else if (index === 2) {
      return 400; // Second slide duration
    } else {
    ...
    <>
      <WebLayout _class_ID="" _class=" ">
        <div className="mx-auto flex justify-center flex-col ">
          ...
          <div className=" mx-auto productSlider ">
            <Slider {...settings} adaptiveHeight={true}>
              {data.map((video, index) => (
                ...
                >
                  <div className="  rounded-3xl overflow-hidden productSlide">
